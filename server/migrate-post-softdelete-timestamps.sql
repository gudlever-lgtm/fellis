...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS edited_at DATETIME NULL DEFAULT NULL;
ALTER TABLE posts ADD COLUMN IF NOT EXISTS deleted_at DATETIME NULL DEFAULT NULL;
