...
export const EGG_IDS = ['chuck', 'matrix', 'flip', 'retro', 'gravity', 'party', 'rickroll', 'watcher', 'riddler', 'phantom']
...
const EGG_DEFAULTS = {
  ...
  phantom:  { discovered: false, enabled: true, activationCount: 0, firstDiscoveredAt: null },
}
