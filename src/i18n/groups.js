export default {
  da: {
    groups: {
      ...
      joined: 'Tilmeldt',
      followGroup: 'Følg',
      followingGroup: 'Følger',
      unfollowGroup: 'Følger',
      followers: 'følgere',
      goToGroup: 'Gå til gruppe',
      ...
      eventLocationPlaceholder: 'Sted (valgfrit)',
      rsvpGoing: 'Deltager',
      rsvpMaybe: 'Måske',
      ...
      createPollSubmit: 'Opret',
      pollQuestionPlaceholder: 'Spørgsmål...',
      pollOptionPlaceholder: 'Svarmulighed',
      pollAddOption: 'Tilføj svarmulighed',
      ...
      coverUploadDone: 'Baggrund gemt',
      coverUploadError: 'Upload fejlede — prøv igen',
      typeTooltip: 'Offentlig: alle kan se og tilmelde sig gruppen.\nPrivat: alle kan se gruppen, men skal godkendes for at blive medlem.\nSkjult: gruppen er ikke synlig i søgning — kun adgang via direkte link.',
      categoryTooltip: 'Interesse: hobby eller fritidsemne.\nLokal: geografisk forankret fællesskab.\nProfessionel: faglig eller erhvervsmæssig gruppe.\nBegivenhed: midlertidig gruppe til et event.\nAndet: passer ikke i de øvrige kategorier.',
      dangerZone: 'Farezone',
  ...
  en: {
    groups: {
      ...
      joined: 'Joined',
      followGroup: 'Follow',
      followingGroup: 'Following',
      unfollowGroup: 'Following',
      followers: 'followers',
      ...
      coverUploadDone: 'Background saved',
      coverUploadError: 'Upload failed — try again',
      typeTooltip: 'Public: anyone can see and join the group.\nPrivate: anyone can see the group, but must be approved to join.\nHidden: the group is invisible in search — access via direct link only.',
      categoryTooltip: 'Interest: hobby or leisure topic.\nLocal: geographically rooted community.\nProfessional: work or career-focused group.\nEvent: temporary group tied to a specific event.\nOther: doesn\'t fit the other categories.',
