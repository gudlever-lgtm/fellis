...
export const PT = {
  da: {
    ...
    postInputHint: 'Skriv et opslag og tryk "Opslå". Du kan vedhæfte billeder og videoer.',
    msgInputHint: 'Skriv en besked og tryk Enter eller "Send".',
    post: 'Opslå',
    like: 'Synes godt om',
    comment: 'Kommentar',
    share: 'Del',
  ...
  en: {
    ...
    postInputHint: 'Write a post and click "Post". You can attach images and videos.',
    msgInputHint: 'Type a message and press Enter or "Send".',
    post: 'Post',
    like: 'Like',
    comment: 'Comment',
    share: 'Share',
